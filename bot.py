...
MFE_RR_MULTIPLIERS = {
    "🔥점화": 1.5,              # SL 2.0%×1.5=3.0%
    "강돌파 (EMA↑+고점↑)": 1.5,  # SL 2.0%×1.5=3.0%
    "EMA↑": 1.5,                 # SL 2.0%×1.5=3.0%
    "고점↑": 1.5,                # SL 2.0%×1.5=3.0%
    "거래량↑": 1.5,              # SL 2.0%×1.5=3.0%
    "기본": 1.5,                 # SL 2.0%×1.5=3.0%
}
...
TRAIL_DISTANCE_MIN_BASE = 0.005  # 🔧 v6: 0.15% → 0.5% (26코인 50h 백테스트 최적)
