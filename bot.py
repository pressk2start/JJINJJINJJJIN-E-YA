...
PROFIT_CHECKPOINT_BASE = 0.0020  # 🔧 리뷰반영: 0.30→0.20% (MFE P25=0.19% 감안, 수익 실현 빈도 증가)
...
TRAIL_DISTANCE_MIN_BASE = 0.0025  # 🔧 캔들분석: 0.30→0.25% (Trail 0.20% 포착 0.136% 최고, 0.25%는 균형점)
