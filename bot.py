...
DYN_SL_MIN = 0.005   # 🔧 30일분석: SL 0.5% (10233건 최적 SL0.5/A0.2/T0.1)
DYN_SL_MAX = 0.010   # 🔧 30일분석: SL_MAX 1.0% (고변동 여유)

# 🔧 통합 체크포인트: 트레일링/얇은수익/Plateau 발동 기준
# 🔧 구조개선: SL 연동 — 체크포인트 = SL × 1.5 (의미있는 수익에서만 트레일 무장)
#   기존 0.30%에서 무장 → 진입가+0.06%에 트레일스톱 → 한 틱에 트립 문제 해결
PROFIT_CHECKPOINT_BASE = 0.002  # 🔧 30일분석: Activation 0.2% (SL0.5/A0.2/T0.1 최적)
...
TRAIL_DISTANCE_MIN_BASE = 0.001  # 🔧 30일분석: Trail 0.1% (SL0.5/A0.2/T0.1 최적)
