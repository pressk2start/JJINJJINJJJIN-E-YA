...
# 16. 코인 손실 관리
# ============================================================
COIN_LOSS_MAX = 3  # 완화 (사용자 요청): 2→3 (15분 내 3회 손절 시 차단)
...
STATE_PERSIST_INTERVAL = 60  # 60초마다 자동 저장 (I/O 스파이크 완화)
...
SHADOW_STATS_SAVE_INTERVAL = 50   # N건마다 저장 (10→50: deepcopy+indent 제거 후에도 빈도 축소)
