...
TARGET_PROFIT_PCT = 0.25      # 목표 수익률 도달 시 즉시 청산
MAX_HOLD_SEC = 180            # 최대 보유 시간 (초)
COOLDOWN_SEC = 600            # 같은 종목 재진입 대기 (NEAR 과집중 완화: 120→600)
...
EARLY_EXIT_ENTRY_PCT = 0.30   # [I] 진입가 대비 하락 시 즉시 청산 (0.20%→0.30%: 9/9 회복 데이터 기반 완화)
MAX_ENTRIES_PER_COIN = 3      # [J] 세션당 동일 종목 최대 진입 횟수 (SOL 8/14 집중 방지)
